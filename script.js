...
const etunimi='Mira'; //string
const sukunimi='Vorne'; //string
const syntymavuosi=1977; //number, eli kokonaisluku
...
//ul.firstElementChild.textContent = 'HTML tehty';
//ul.children[1].innerText = 'CSS tehty';
//ul.lastElementChild.innerHTML = '<h1>CI/CD tarviin apua!</h1>';
...
kurssinappi.addEventListener('click', e => {
  ...
  document.getElementById('opiskelija-lomake').style.background = '#ccc';
  document.querySelector('body').classList.add('uusiTausta');
  if(nimiSisalto.value === '' || asiaSisalto.value === '') {
    ...
    kurssinappi.value='Virhe, tietoa ei lisätä';
